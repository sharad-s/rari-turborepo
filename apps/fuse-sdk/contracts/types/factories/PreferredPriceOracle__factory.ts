...
export class PreferredPriceOracle__factory extends ContractFactory {
  constructor(...args: PreferredPriceOracleConstructorParams) {
    ...
    this.contractName = "PreferredPriceOracle";
  }

  deploy(
    _chainlinkOracle: string,
    _secondaryOracle: string,
  ...
  attach(address: string): PreferredPriceOracle {
    return super.attach(address) as PreferredPriceOracle;
  }
  connect(signer: Signer): PreferredPriceOracle__factory {
    return super.connect(signer) as PreferredPriceOracle__factory;
  }
  static readonly contractName: "PreferredPriceOracle";
  public readonly contractName: "PreferredPriceOracle";
