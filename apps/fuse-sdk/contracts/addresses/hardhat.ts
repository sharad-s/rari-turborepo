...
export default {
  ...
  oracles: {
    ...
    HarvestPriceOracleV1: {
      address: "0x8D364609cd2716172016838fF9FBC7fBcAC91792", // v1.1.4
      bytecodeHash:
        "0x6e23380d1d640118cf80cf2bfa9ca7a89068659dfcb50abc0a7f8b9e5f9daab7",
      deployable: false,
      oldVersions: {},
    ...
    HarvestPriceOracleV2: {
      address: "0x6141d9353bb1fb8131d07d358c112b372aa92514", // v1.2.1
      bytecodeHash:
        "0x5eff948725404a38311ebe4b3bafc312f63dd8ae611e3ddcdfebb9cfa231988c",
      deployable: false,
      oldVersions: {},
  ...
  UNISWAP_TWAP_PRICE_ORACLE_V2_FACTORY_CONTRACT_ADDRESS:
    "0x3472f7e0179Fe15cd7450C9c5269C876fAc64B73", // TODO: Set correct mainnet address after deployment
